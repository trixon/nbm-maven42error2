# nbm-maven42error2
When using nbm-maven 4.2 the generated etc/conf gets an extra " on the following line:
default_cachedir=""${DEFAULT_CACHEDIR_ROOT}/dev"
making the application unable to launch.
...
default_options="--branding nbmmaven42error2"
